...
const config = {
  SESSION_ID: process.env.SESSION_ID || "JOEL~XMD~cDzPBfkE",
  PREFIX: process.env.PREFIX || '.',
//let's add menu captions by lord joel
   BOT_NAME: process.env.BOT_NAME || "ʙᴇʀʟɪɴ ᴊᴏᴅ ʙᴏᴛ ᴠ¹⁰",
  CAPTION: process.env.CAPTION|| "ᴘᴏᴡᴇʀᴇᴅ ʙʏ ʙᴇʀʟɪɴ ᴊᴏᴅ",
// don't use my codes without a permission 🙏
  ...
  SUDO_NUMBER: process.env.SUDO_NUMBER || "919946652925",
